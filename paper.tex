...
underlying resources using intelligent\km{elaborate} and dynamic\km{elaborate} scheduling policies. A
...
environments~\cite{peg-cloud}.\km{elaborate, does not seem to do GPU
computing}.

\paragraph{Wings/--} Wings is a Workflow system which does software choreography based on AI techniques~\cite{wings2013}. \km{elaborate}.
