...
%
\paragraph{Makeflow} Makeflow~\cite{makeflow} is a make-like workflow platform.
...
`actor' in Kepler. Recent advances in Kepler include MapReduce style computation, bioinformatics
