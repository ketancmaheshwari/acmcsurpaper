...
DAG~\cite{caron-desprez:2005},\km{could not find any recent paper on MA DAG, interesting concept} engine is one example of a DAG generator engine. MA
...
\begin{itemize}
    ...
    \item \textbf{Web Presence.} Documentation and other information from the web pages of the host SWE.
